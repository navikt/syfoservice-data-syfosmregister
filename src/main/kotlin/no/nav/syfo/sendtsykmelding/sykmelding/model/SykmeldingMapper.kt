...
import no.nav.syfo.sendtsykmelding.model.Adresse
import no.nav.syfo.sendtsykmelding.model.AktivitetIkkeMulig
import no.nav.syfo.sendtsykmelding.model.AnnenFraverGrunn
import no.nav.syfo.sendtsykmelding.model.AnnenFraversArsak
import no.nav.syfo.sendtsykmelding.model.Arbeidsgiver
import no.nav.syfo.sendtsykmelding.model.ArbeidsgiverDbModel
import no.nav.syfo.sendtsykmelding.model.ArbeidsrelatertArsak
import no.nav.syfo.sendtsykmelding.model.ArbeidsrelatertArsakType
import no.nav.syfo.sendtsykmelding.model.Behandler
import no.nav.syfo.sendtsykmelding.model.ErIArbeid
import no.nav.syfo.sendtsykmelding.model.ErIkkeIArbeid
import no.nav.syfo.sendtsykmelding.model.Gradert
import no.nav.syfo.sendtsykmelding.model.KontaktMedPasient
import no.nav.syfo.sendtsykmelding.model.MedisinskArsak
import no.nav.syfo.sendtsykmelding.model.MedisinskArsakType
import no.nav.syfo.sendtsykmelding.model.MedisinskVurdering
import no.nav.syfo.sendtsykmelding.model.MeldingTilNAV
import no.nav.syfo.sendtsykmelding.model.Periode
import no.nav.syfo.sendtsykmelding.model.Periodetype
import no.nav.syfo.sendtsykmelding.model.Prognose
import no.nav.syfo.sendtsykmelding.model.SporsmalSvar
import no.nav.syfo.sendtsykmelding.model.StatusDbModel
import no.nav.syfo.sendtsykmelding.model.SvarRestriksjon
