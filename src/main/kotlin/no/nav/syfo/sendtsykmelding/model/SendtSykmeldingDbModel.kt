package no.nav.syfo.sendtsykmelding.model
...
fun ResultSet.toSendtSykmeldingDbModel(): SendtSykmeldingDbModel {
    return SendtSykmeldingDbModel(sykmeldingsDokument = objectMapper.readValue(getString("sykmelding"), Sykmelding::class.java),
        id = getString("id"),
...
data class SendtSykmeldingDbModel(
    val id: String,
