...
class SykmeldingStatusKafkaProducer(
    ...
    fun send(sykmeldingStatusKafkaEventDTO: SykmeldingStatusKafkaEventDTO, source: String, fnr: String) {
        ...
        val metadataDTO = KafkaMetadataDTO(sykmeldingId = sykmeldingStatusKafkaEventDTO.sykmeldingId, timestamp = OffsetDateTime.now(
            ZoneOffset.UTC), fnr = fnr, source = source)
